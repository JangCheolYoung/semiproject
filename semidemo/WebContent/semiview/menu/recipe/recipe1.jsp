...
<body>
		...
		<div id="content" alt="페이지마다 바뀔 DIV 요소입니다. css 설정 안해놓은 상태입니다.">
			...
			<div id="inputContent">
				...
				<c:forEach var="dto" items="${list}">
					<table align="center">
						<tr>
							<td><img src="../semiview/images/${dto.growth_level}.png"
								id="lv_img"></td>
							<td><p>요리명</p></td>
						...
						<tr>
							<td rowspan="2"><img
								src="../semiview/images/${dto.main_picture}" id="recipe_img">
							</td>
							<td><p>재료</p></td>
	...
	<footer>
		<a href="#top"><img id=bottom src="../semiview/images/top_img.png"></a>
	</footer>
