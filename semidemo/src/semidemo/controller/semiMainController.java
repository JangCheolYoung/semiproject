...
import semidemo.recipeAction.RecipeGetAction;
import semidemo.recipeAction.RecipeListAction;
...
////////////////////////////////////////////////////////////////////////////////////////////////
		// 레시피
		...
		}else if(action.equals("/viewRecipe.do")) {
			// 초기 중기 후기 완료기 레시피를 보여줌.
			RecipeListAction recipeList = new RecipeListAction();
			...
			// 검색하는 페이지로 이동.
			path = "/semiview/menu/recipe/search.jsp";
			
		}else if(action.equals("/recipeSearch.do")) {
			//디비에서 검색어가 포함된 레시피를 가져옴
			RecipeGetAction recipeGet = new RecipeGetAction();
			recipeGet.execute(req, resp);
			
			String data = req.getParameter("data");
			path = "/semiview/menu/recipe/resultRecipe.jsp?data="+data;
