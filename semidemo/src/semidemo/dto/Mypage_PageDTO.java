...
public class Mypage_PageDTO {
	private int currentPage; // 현재페이지
	private int totalCount; // 총 레코드수 
	private int blockCount = 4; // 한 페이지에 보여줄 레코드수 (원래는 10개정도, 테스트 용으로 적게 줄임)
	...
	public Mypage_PageDTO() {

	}

	public Mypage_PageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
       this(currentPage,totalCount);
       this.searchKey=searchKey;
       this.searchWord=searchWord;
	}

	public Mypage_PageDTO(int currentPage, int totalCount) {
