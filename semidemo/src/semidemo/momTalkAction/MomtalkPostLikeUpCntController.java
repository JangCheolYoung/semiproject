...
@WebServlet("/mammaMain/likeUpCnt")
public class MomtalkPostLikeUpCntController extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("MomtalkPostLikeUp In");
		...
		dao.likeUpCntMethod(momtalk_post_num);
